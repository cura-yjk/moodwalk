...
ActiveRecord::Schema[8.1].define(version: 2026_09_15_221836) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "location_manually_set", default: false, null: false
    t.string "name"
    t.jsonb "recent_locations", default: [], null: false
